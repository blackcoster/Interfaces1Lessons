...
class Window(QtWidgets.QWidget):
    ...
    def openFile(self):
        ...
        # добавление файла из кода ( не пользователь выбирает)
        # mc = QtMultimedia.QMediaContent(QtCore.QUrl.fromLocalFile(r'audio1.mp3'))
        # self.mplPlayer.setMedia(mc)
        #
        # mc = QtMultimedia.QMediaContent(QtCore.QUrl(r'http://www.someradio.ru/playlist.m3u8'))
        # self.mplPlayer.setMedia(mc)
